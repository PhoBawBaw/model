...
def main():
    ...
    label_map = {0: 'Belly_pain', 1: 'Cold_hot', 2: 'Discomfort', 3: 'Don’t_know', 4: 'Hungry', 5: 'Lonely', 6: 'Needs_to_burp', 7: 'Scared', 8: 'Tired'}
    # 모델 초기화 및 가중치 로드
    ...
    # 예측 수행
    predicted_class = predict_audio_class(model, audio_file, label_map)
    # print(f'The predic`ted class for the input audio file is: {predicted_class}')

    return predicted_class
if __name__ == '__main__':
    predicted_class = main()
